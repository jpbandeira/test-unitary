...
public class LivroServiceTest {
	...
	public void processoParaEditarLivroDaListaDeLivros() {
		assertEquals("quando chamado o metodo alugar livro, o mesmo deve retornar Sucesso", mensagemDeRetorno, this.livroService.SalvarLivro(this.id, nome, autor, anoDeCriacao));
	...
	public void processoParaInativarLivroDaListaDeLivros() {
		...
		assertEquals("quando chamado o metodo alugar livro, o mesmo deve retornar Sucesso", mensagemDeRetorno, this.livroService.SalvarLivro(id, nome, autor, anoDeCriacao));
