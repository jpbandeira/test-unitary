...
public class LivroServiceTest {
	...
	public void processoParaSalvarLivroNaListaDeLivros() {
		assertEquals("Quando chamado o metodo salvar livro, o mesmo deve retornar Sucesso", mensagemDeRetorno, this.livroService.salvarLivro(livro1));
		//assertEquals("Quando chamado o metodo salvar livro, o mesmo deve retornar Sucesso", mensagemDeRetorno, this.livroService.salvarLivro(livro1));
	...
	public void processoParaEditarLivroDaListaDeLivros() {
		...
		assertEquals("Verificando se o valor do atributo realmente foi editado", "Senhor", livroService.getListaDeLivros().get(livro1.getId() - 1).getNome());
	}
	...
	public void processoParaInativarLivroDaListaDeLivros() {
		...
		assertEquals("Quando chamado o metodo inativarLivro, o mesmo tem que retornar Sucesso", mensagemDeRetorno,
				this.livroService.inativarLivro(livro1));
